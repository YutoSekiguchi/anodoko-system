...
<script>
import ResultTitle from '~/components/results/character/ResultTitle.vue'
import ResultMain from '~/components/results/character/ResultMain.vue'
import Graph from '~/components/results/character/Graph.vue'
import ResultElse from '~/components/results/character/ResultElse.vue'
